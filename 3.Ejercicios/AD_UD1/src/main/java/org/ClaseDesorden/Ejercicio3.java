...
public class Ejercicio3 {
    public static void main(String[] args) throws IOException {
         ...
         *
         * Escribe un programa en Java que funcione como un gestor básico de archivos y directorios.
         ...
         * El programa debe ofrecer un menú para que el usuario elija la operación que desea realizar.
         * La selección de directorios o archivos debe realizarse con la clase JFileChooser.
         */
    }
}
